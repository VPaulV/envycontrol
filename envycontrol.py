...
XORG_PATH_HYBRID = '/etc/X11/xorg.conf.d/90-intel-hybrid.conf'

XORG_CONTENT_INTEL_HYBRID = '''#Do not modify this file
# Generated by EnvyControl
...
def _switcher(mode, display_manager = ''):
    ...
    if mode == 'integrated':
        ...
        with open(NVIDIA_MODESET_PATH, mode='w', encoding='utf-8') as f:
            f.write(NVIDIA_MODESET_CONTENT)
        with open(XORG_PATH_HYBRID, mode='w', encoding='utf-8') as f:
            f.write(XORG_CONTENT_INTEL_HYBRID)
        _rebuild_initramfs()
